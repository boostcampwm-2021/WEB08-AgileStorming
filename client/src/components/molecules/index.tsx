...
export { default as MonthController } from 'components/molecules/Temp/MonthController';
...
export { default as PlayController } from 'components/molecules/Temp/PlayController';
